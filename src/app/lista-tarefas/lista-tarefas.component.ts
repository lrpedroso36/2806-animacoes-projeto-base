import { checkButtonTrigger, formButtonTrigger, filterTrigger, flyInOutTrigger, shakeTrigger, listStateTrigger } from './../animations';
import { Component, OnInit } from '@angular/core';
import { FormBuilder, FormGroup, Validators } from '@angular/forms';

import { TarefaService } from 'src/app/service/tarefa.service';
import { Tarefa } from '../interface/tarefa';
import { higthligthStateTrigger, shownStateTrigger } from '../animations';
...
export class ListaTarefasComponent implements OnInit {
  ...
  trarefasSubscription: Subscription = new Subscription();
  ...
  ngOnInit(): void {
    this.service.listar();
    this.trarefasSubscription = this.service.tarefa$.subscribe((tarefas) => {
...
filtrarTarefasPorDescricao(descricao: string) {
  ...
  editarTarefa() {
    if(this.formulario.valid) {
      ...
      this.service.editar(tarefa, true);
      this.resetarFormulario();
    }
  }
